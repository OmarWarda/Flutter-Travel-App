class Activity {
  ...
  static const List<Activity> activities = [
    Activity(
      ...
      description:
          'Cruising and Snorkeling the Amalfi Coast offers a breathtaking and immersive experience along one of Italys most stunning coastlines. Nestled along the southern edge of the Sorrentine Peninsula in the Tyrrhenian Sea, the Amalfi Coast is renowned for its dramatic cliffs, picturesque towns, and crystal-clear waters.',
      imageUrl:
